...
?>
			                        ...
			                        <p>This is your form description. Click here to edit.</p>
                                                ...
                                                <ul >
                                                    ...
                                                    <li id="li_115" >
                                                        ...
                                                        <select class="element select small" id="element_115" name="shift" required/>
                                                    ...
                                                    <li id="li_15" >
                                                        ...
                                                        <div>
                                                            <select class="medium" id="element_15" name="roughing" required /> 
                                                            <option disabled selected value> -- select -- </option>
                                                    ...
                                                    <li id="li_16" >
                                                        ...
                                                        <div>
                                                            <select class="medium"  name="heatnumber" id="heatnumber" required/>
                                                           <option disabled selected value> -- select -- </option>
 ...
 <li id="li_2">
       ...
       function getTimeOnly(){
        var heatEndTime = document.getElementById('heatendtime').value;
       var heatStartTime = document.getElementById('heatstarttime').value;
       alert('hi');
       var endDate =   new Date(heatEndTime);
       var startDate = new Date(heatStartTime);
        document.getElementById('sTime_only').value=startDate.getHours() + ':' + ((startDate.getMinutes()<10?'0':''));
        document.getElementById('eTime_only').value = endDate.getHours() + ':' + ((endDate.getMinutes()<10?'0':''));
    }
    return true;
 </script>
                                                        ...
                                                        <h5 style="color:#8B0000;"><b>MILL-1 SIZE-1</b></h5>
                                                            ...
                                                            <li id="li_13" >
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select class="medium" id="element_13" name="m1s1" required/>
...
while ($row_per = mysqli_fetch_array($size1)):;
    ?>
                                                            ...
                                                            <li id="li_5" >
                                                                ...
                                                                <div>
                                                                    <input id="element_5" name="3mbwtm1s1" class="medium" type="text" maxlength="255" onkeypress="return IsDecimalm1s1(event);" /> 
                                                                </div> 
                                                            ...
                                                            <li id="li_9" >
                                                                ...
                                                                <div>
                                                                    <input id="element_9" name="rpm1s1" class="medium" type="text" maxlength="255" value="" onkeypress="return IsNumrpm1s1(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_14" >
                                                                ...
                                                                <div>
                                                                    <select class="medium" id="element_14" name="m1s2" required> 
                                                                        <option disabled selected value> -- select -- </option>
<?php
...
while ($row_per = mysqli_fetch_array($size1)):;
    ?>  
                                                            ...
                                                            <li id="li_51" >
                                                                ...
                                                                <div>
                                                                    <input id="element_51" name="3mbwtm1s2" class="medium" type="text" maxlength="255"  onkeypress="return IsDecimalm1s2(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_91" >
                                                                ...
                                                                <div>
                                                                    <input id="element_91" name="rpm1s2" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumrpm1s2(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_80" >
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select class="medium" id="element_80" name="m2s1" required/>
                                                            ...
                                                            <li id="li_81" >
                                                                ...
                                                                <div>
                                                                    <input id="element_81" name="3mbwtm2s1" class="medium" type="text" maxlength="255" value="" onkeypress="return IsDecimalm2s1(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_82" >
                                                                ...
                                                                <div>
                                                                    <input id="element_82" name="rpm2s1" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumrpm2s1(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_80" >
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select class="medium" id="element_80" name="m2s2"required/>
                                                            ...
                                                            <li id="li_81" >
                                                                ...
                                                                <div>
                                                                    <input id="element_81" name="3mbwtm2s2" class="medium" type="text" maxlength="255" value=""onkeypress="return IsDecimalm2s2(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_83" >
                                                                ...
                                                                <div>
                                                                    <input id="element_9" name="rpm2s2" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumrpm2s2(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_111" >
                                                                ...
                                                                <div>
                                                                    <input id="element_111" name="bwt3m3s" class="medium" type="text" maxlength="255" value=""onkeypress="return IsDecimal3s3m(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_112" >
                                                                ...
                                                                <div>
                                                                    <input id="element_112" name="bwt6m3s" class="medium" type="text" maxlength="255" value="" onkeypress="return IsDecimal3s6m(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_11" >
                                                                ...
                                                                <div>
                                                                    <input id="element_11" name="bbp3mtr3s" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumbbp3(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_12" >
                                                                ...
                                                                <div>
                                                                    <input id="element_12" name="bbp6mtr3s" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumbbp6(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_71" >
                                                                ...
                                                                <div>
                                                                    <input id="element_71" name="3mtrbwtccm" class="medium" type="text" maxlength="255" value="" onkeypress="return IsDecimalccm3m(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_72" >
                                                                ...
                                                                <div>
                                                                    <input id="element_72" name="3mtrbbpccm" class="medium" type="text" maxlength="255" value="" onkeypress="return IsNumbbp3c(event);" /> 
                                                                </div> 
                                                            ...
                                                            <li id="li_75" >
                                                                ...
                                                                <div>
                                                                    <input id="element_75" name="6mtrbwtccm" class="medium" type="text" maxlength="255" value="" onkeypress="return IsDecimalccm6m(event);"/> 
                                                                </div> 
                                                            ...
                                                            <li id="li_76" >
                                                                ...
                                                                <div>
                                                                    <input id="element_76" name="6mtrbypassccm" class="medium" type="text" maxlength="255" value=""onkeypress="return IsNumbbp6c(event);"/> 
                                                                </div> 
